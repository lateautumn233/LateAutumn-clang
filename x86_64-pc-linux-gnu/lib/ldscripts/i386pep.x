...
SEARCH_DIR("/tmp/cirrus-ci-build/installTmp/x86_64-pep/lib"); SEARCH_DIR("/tmp/cirrus-ci-build/installTmp/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
